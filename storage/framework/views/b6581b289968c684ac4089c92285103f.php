...
<a href="<?php echo e(route('penjualan.create')); ?>" class="btn btn-buat mb-4">Tambah Transaksi Baru</a>
...
<table class="table align-middle text-center">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="font-weight: 600;"><?php echo e($sale->created_at->translatedFormat('d-m-Y H:i:s')); ?></td>
            <td class="text-start"><?php echo e($sale->user->name); ?></td>
            <td style="font-weight: 700; color: #be185d;">Rp <?php echo e(number_format($sale->total_pembayaran)); ?></td>
            <td>
            ...
            <td>
                <span class="status-badge <?php echo e(strtolower($sale->status) == 'completed' ? 'status-completed' : 'status-open'); ?>">
            ...
            <td>
                <div class="d-flex align-items-center justify-content-center gap-2">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view', $sale)): ?>
                        <a href="<?php echo e(route('penjualan.edit', $sale)); ?>" class="btn btn-edit-akun btn-sm">Edit</a>
                    <?php endif; ?>
                    
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete', $sale)): ?>
                    <form action="<?php echo e(route('penjualan.destroy', $sale)); ?>" method="POST" class="d-inline m-0">
                        <?php echo csrf_field(); ?>
